...
// const { sendToChatbot, createWhatsAppSession, sessions } = require('../chatbot_no_database');
...
// // Untuk mendapatkan __dirname di CommonJS (karena tidak pakai ES Module)
// const _filename = __filename || require('url').fileURLToPath(require('import.meta').url);
...
//       const qrPath = path.join(_dirname, '..', '..', 'qrcodes', `${sessionName}.png`);
